...
const ULR = 'http://192.168.1.55:3000/api'
...
export default class EnviarMantenimiento extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            this.state.mantenimiento = JSON.parse(await AsyncStorage.getItem('Mantenimiento1')) || []
        } catch (e) {
            console.log(e);
        }
    }
    ...
    _post = (item) => {
        ...
        RNFetchBlob.fetch('POST', `${ULR}/mantenimiento/nuevo`, {
                        ...
                        <CardItem footer>
                            <View style={{left: 100}}>
                                <Button style={styles.centerButton} block rounded
                                    ...
                                    <Text
                                        style={{fontWeight: 'bold'}}>Cerrar &times;</Text>
                                </Button>
                                ...
                                <ScrollView>
                                    ...
                                    {item.ManoObra.map(value => (
                                        <View style={styles.borderCard}>
                                            ...
                                            <Text>
                                                Horas trabajadas: {value.horasTrabajadas}
                                            </Text>
                                ...
                                <ScrollView>
                                    {item.Repuestos.map(value => (
                                        ...
                                        <View style={styles.borderCard}>
                                            ...
                                            <Text>DescripcionRepo: {value.descripcion_repuesto}</Text>
                        ...
                        <Body>
                            <ScrollView>
                                ...
                                <View style={{margin: 10}}>
                                    ...
                                    <Text>Fecha
                                        cotización: {datos.fecha_cotizacion}</Text>
                            ...
                            <Content>
                                <Card key={key}>
                                    <CardItem header bordered>
                                        <Text>
                                            <Icon name={'users'}
                                                  size={20}/> Cliente: {item.ContactoCliente}
                                        </Text>
                                    </CardItem>
                                    <CardItem bordered>
                                        <Body>
                                            <CardItem bordered>
                                                <Left>
                                                    <Text style={{textAlign: 'center'}}>
                                                        <Icon name={'info-circle'} color={'#24b62b'}
                                                              size={15}/> Información:
                                                    </Text>
                                                </Left>
                                            ...
                                            <CardItem bordered>
                                                <Left>
                                                    <Text>
                                                        <Icon name={'dollar-sign'} color={'#24b62b'}
                                                              size={15}/> Viaticos:
                                                        {item.totalCostos_v}
                                                    </Text>
                                                </Left>
                                                <Right>
                                                    <Button onPress={() => this.setModalVisible(item)}>
                                                        <Text>
                                                            <Icon name={'eye'} color={'#fff'} size={20}/>
                                                        </Text>
                                                    </Button>
                                            ...
                                            <CardItem bordered>
                                                <Left>
                                                    <Text>
                                                        <Icon name={'dollar-sign'} color={'#24b62b'}
                                                              size={15}/> Mano de obra: {item.totalMano_o}
                                                    </Text>
                                                </Left>
                                                <Right>
                                                    <Button onPress={() => this.setModalVisible2(item)}>
                                                        <Text>
                                                            <Icon name={'eye'} color={'#fff'} size={20}/>
                                                        </Text>
                                                    </Button>
                                            ...
                                            <CardItem bordered>
                                                <Left>
                                                    <Text>
                                                        <Icon name={'dollar-sign'} color={'#24b62b'}
                                                              size={15}/> Repuestos: {item.totalRepuestos}
                                                    </Text>
                                                </Left>
                                                <Right>
                                                    <Button onPress={() => this.setModalVisible3(item)}>
                                                        <Text>
                                                            <Icon name={'eye'} color={'#fff'} size={20}/>
                                                        </Text>
                                                    </Button>
                                            ...
                                            <CardItem bordered>
                                                <Left>
                                                    <Text>
                                                        <Icon name={'dollar-sign'} color={'#24b62b'}
                                                              size={15}/> Trabajos externos: {item.totalTrabajos_e}
                                                    </Text>
                                                </Left>
                                                <Right>
                                                    <Button onPress={() => this.setModalVisible4(item)}>
                                                        <Text>
                                                            <Icon name={'eye'} color={'#fff'} size={20}/>
                                                        </Text>
                                                    </Button>
                                            ...
                                            <CardItem bordered>
                                                <Left>
                                                    <Text>
                                                        <Icon name={'images'} color={'#24b62b'}
                                                              size={15}/> Fotos:
                                                    </Text>
                                                </Left>
                                                <Right>
                                                    <Button onPress={() => this.setModalVisible5(item)}>
                                                        <Text>
                                                            <Icon name={'eye'} color={'#fff'} size={20}/>
                                                        </Text>
                                                    </Button>
                                    ...
                                    <CardItem onPress={this._post.bind(this, item)}
                    ...
                    <Modal animationType="slide" transparent={true}
                        ...
                        <View style={styles.loaderStyle}>
                            ...
                            <View style={styles.container}>
                                <Animated.View style={[
                                    styles.inner, {width: this.state.downloadProgress + '%'},
                                ]}/>
                ...
                <Grid>
                    <Col>
                        <Button style={{margin: 5}} onPress={this.ListarPendientes}>
                            <Text><Icon name={'sync'} size={18}/> Actualizar</Text>
                        </Button>
                    </Col>
                    <Col>
                        <Button dark style={{margin: 5}} onPress={this.VaciarLista}>
                            <Text><Icon name={'trash'} size={18}/> Limpiar</Text>
                        </Button>
                    </Col>
                </Grid>
