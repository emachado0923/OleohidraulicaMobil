...
export default class MaintenanceForm extends React.Component {
  ...
  //Mano de obra
  _Fecha2 = (inicial) => {
    let fecha2 = `${inicial.getFullYear()}-${
      inicial.getMonth() + 1
    }-${inicial.getDate()}`;
  ...
  //Hora inicial
  _HoraInicial = (date) => {
    let horaIngreso = moment(date).format('HH:mm');

    this.setState({horaIngreso: horaIngreso});
  ...
  //Hora final
  _HoraFinal = (date2) => {
    let horaSalida = moment(date2).format('HH:mm');
    this.setState({horaSalida: horaSalida});
  ...
  _FechaInicial = (inicial) => {
    let fechaIngreso = `${inicial.getFullYear()}-${
      inicial.getMonth() + 1
    }-${inicial.getDate()}`;
  ...
  //Fecha Final
  _FechaFinal = (final) => {
    let fechaSalida = `${final.getFullYear()}-${
      final.getMonth() + 1
    }-${final.getDate()}`;

    this.setState({fechaSalida: fechaSalida});
  ...
  //Fecha de Cotización
  _FechaCotizacion = (Cotizacion) => {
    let fecha_cotizacion = `${Cotizacion.getFullYear()}-${
      Cotizacion.getMonth() + 1
    }-${Cotizacion.getDate()}`;

    this.setState({fecha_cotizacion: fecha_cotizacion});
  ...
  render() {
    ...
    return (
      <Root>
        {this.header()}
        <Formik
          initialValues={NuevoMantenimiento}
              ...
              <View style={style.modalBody}>
                <View>
                  ...
                  <View>
                    <View style={{margin: 5}}>
                      ...
                      <View style={style.stylePicker}>
                        ...
                        <Picker
                          selectedValue={values.forma_de_pago}
                      ...
                      <TextInput
                        onChangeText={handleChange('vigencia')}
                      ...
                      <TextInput
                        onChangeText={handleChange('tiempo_lugar')}
                        onBlur={() => setFieldTouched('tiempo_lugar')}
                        value={values.tiempo_lugar}
                        style={style.InputS}
                        returnKeyType="next"
                        placeholder={'Lugar y tiempo de entrega'}
                      />
                  ...
                  <View style={style.stylePicker}>
                    ...
                    <Picker
                      selectedValue={values.estado_cotizacion}
                      onValueChange={handleChange('estado_cotizacion')}
                      onBlur={() => setFieldTouched('estado_cotizacion')}>
                      <Picker.Item label={'INICIAL'} value={'1'} />
                      <Picker.Item label={'FINAL'} value={'0'} />
                    </Picker>
                  </View>
                  {/*fecha Cotizacion*/}
                  <View style={style.timeContainer}>
                    <Grid>
                      <Col>
                        <TouchableOpacity
                          style={{margin: 3}}
                          onPress={this._showDatePicker3}>
                          <Text style={{fontWeight: 'bold'}}>
                            <Icon name={'calendar-day'} size={25} /> Fecha de
                            Cotización:
                          </Text>
                        </TouchableOpacity>
                      </Col>
                  ...
                  <TextInput
                    onChangeText={handleChange('n_cotizacion')}
                    onBlur={() => setFieldTouched('n_cotizacion')}
                    value={values.n_cotizacion}
                    style={style.InputS}
                  ...
                  <TextInput
                    onChangeText={handleChange('numeroOT')}
                ...
                <View>
                  <Textarea
                    onChangeText={handleChange('descripcionTrabajoRealizar')}
                    ...
                    underline
                  />
                  {touched.descripcionTrabajoRealizar &&
                    errors.descripcionTrabajoRealizar && (
                      <Text style={{fontSize: 15, color: 'red'}}>
                        <Icon name={'exclamation-circle'} size={20} />{' '}
                        {errors.descripcionTrabajoRealizar}
                      </Text>
                ...
                <View style={style.RowGrid}>
                  ...
                  <View style={style.timeContainer}>
                    <View style={{justifyContent: 'center'}}>
                      <TouchableOpacity
                        style={{margin: 3}}
                        onPress={this._showDatePicker2}>
                        <Text style={{fontWeight: 'bold'}}>
                          <Icon name={'calendar-check'} size={25} /> Fecha de
                          salida:
                        </Text>
                      </TouchableOpacity>
                ...
                <View style={style.RowGrid}>
                  ...
                  <View style={style.timeContainer}>
                    <TouchableOpacity
                      style={{margin: 3}}
                      onPress={this._showTimePicker2}>
                      <Text style={{fontWeight: 'bold'}}>
                        <Icon name={'clock'} size={25} /> Hora de Salida:
                      </Text>
                    </TouchableOpacity>
                    <Text style={style.horaTexto}>{this.state.horaSalida}</Text>
                    <DateTimePicker
                ...
                <TextInput
                  onChangeText={handleChange('spinnerUbicacion')}
                  onBlur={() => setFieldTouched('spinnerUbicacion')}
                  value={values.spinnerUbicacion}
                  style={style.InputS}
                  returnKeyType="next"
                ...
                <TextInput
                  onChangeText={handleChange('Horometro')}
                  onBlur={() => setFieldTouched('Horometro')}
                  value={values.Horometro}
                  style={style.InputS}
                ...
                <View style={style.stylePicker}>
                  ...
                  <Picker
                    selectedValue={values.spinnerBombaEstacionaria}
                    ...
                    {this.state.bombaArray.map((item, key) => (
                      <Picker.Item
                        label={item.id + ' - ' + item.nombre_bomba}
                        value={`${item.id}`}
                        key={key}
                      />
                    ))}
                ...
                {touched.spinnerBombaEstacionaria &&
                  errors.spinnerBombaEstacionaria && (
                    <Text style={{fontSize: 15, color: 'red'}}>
                      <Icon name={'exclamation-circle'} size={20} />{' '}
                      {errors.spinnerBombaEstacionaria}
                      <Text>&nbsp;</Text>
                ...
                <View>
                  <View>
                    ...
                    <View style={style.stylePicker}>
                      ...
                      <Picker
                        selectedValue={this.state.especialidad}
                        onValueChange={(itemValue, itemIndex) =>
                          this.setState({especialidad: itemValue})
                        }>
                        {this.state.especialidadArray.map((item, key) => (
                          <Picker.Item
                            label={item.id + ' - ' + item.nombre_especialidad}
                            keyboardType={'numeric'}
                            value={item.id}
                            key={key}
                          />
                    ...
                    <View style={style.RowGrid}>
                      ...
                      <TextInput
                        style={style.InpuTime}
                        onChangeText={(alimentacion) =>
                          this.setState({alimentacion})
                        }
                        keyboardType={'numeric'}
                        returnKeyType="next"
                  ...
                  <View style={style.contenedorTrabajos}>
                    ...
                    {this.state.ViaticosArray.map((item, key) => (
                      <ScrollView style={{alignSelf: 'stretch'}}>
                        <View style={style.DinamicTable} key={key}>
                          <Text style={{alignItems: 'stretch', right: 10}}>
                            <Icon name={'wrench'} size={15} />
                            &nbsp; Personal: {item.numero_personas}&nbsp;
                            Especialidad: {item.especialidad} Subtotal:{' '}
                            {item.subtotal}&nbsp;
                          </Text>
                ...
                <View>
                  ...
                  <View style={style.timeContainer}>
                    <Grid>
                      ...
                      <Col>
                        <Text style={style.horaTexto}>{this.state.fecha2}</Text>
                        <DateTimePicker
                  ...
                  <View style={style.stylePicker}>
                    ...
                    <Picker
                      selectedValue={this.state.especialidad2}
                      onValueChange={(itemValue, itemIndex) =>
                  ...
                  <View
                    ...
                    <TextInput
                      ...
                      onChangeText={(horasTrabajadas) =>
                        this.setState({horasTrabajadas})
                      }
                    />
                  </View>
                    ...
                    {this.state.ManoObraArray.map((item, key) => (
                      <ScrollView style={{alignSelf: 'stretch'}}>
                        <View style={style.DinamicTable}>
                          <Text
                            style={{alignItems: 'stretch', right: 10}}
                            key={key}>
                ...
                {/*Trabajos externos*/}
                <View>
                  <Text style={style.Titulos}>Trabajos externos:</Text>
                  <TextInput
                    style={style.InputS}
                    returnKeyType="next"
                    placeholder={'Descripción'}
                    value={this.state.trabajoDescripcion || 0}
                    onChangeText={(trabajoDescripcion) =>
                      this.setState({trabajoDescripcion})
                    }
                  />
                  ...
                  <TextInput
                    ...
                    keyboardType={'numeric'}
                    placeholder={'Costo'}
                    value={this.state.costoTrabajo || 0}
                    onChangeText={(costoTrabajo) =>
                      this.setState({costoTrabajo})
                    }
                  />
                      ...
                      <ScrollView style={{alignSelf: 'stretch'}}>
                        <View style={style.DinamicTable}>
                          <Text
                            ...
                            &nbsp;Descripción: {item.descripcion} &nbsp;Costo:
                            {item.costo} Valor: {item.valor}
                          </Text>
                          {/*Boton para eliminar una mano de obra*/}
                          <TouchableOpacity
                            style={style.minusButton}
                ...
                <View>
                  ...
                  <TextInput
                    style={style.InputS}
                    onChangeText={(DescripcionRepo) =>
                      this.setState({DescripcionRepo})
                    }
                    numberOfLines={4}
                    value={this.state.DescripcionRepo}
                    multiline
                    returnKeyType="next"
                  ...
                  <View
                    ...
                    <TextInput
                      ...
                      value={this.state.ValorUni}
                    />
                    <Text>&nbsp;</Text>

                    <TextInput
                      style={style.InpuTime}
                      onChangeText={(AIU) => this.setState({AIU})}
                      keyboardType={'numeric'}
                      returnKeyType="next"
                      placeholder={'AIU%'}
                      value={this.state.AIU}
                    />
                  </View>
                  ...
                  <View style={style.albumContainer}>
                    <Button rounded onPress={this._añadirFoto}>
                      <TxT style={{fontWeight: 'bold', textAlign: 'center'}}>
                        <Icon name={'camera-retro'} size={20} /> Añadir
                      </TxT>
                    </Button>
  ...
  addManoObra = () => {
    ...
    if (
      this.state.personal1 === 0 ||
      this.state.personal1 === '' ||
      Horas === 0 ||
      this.state.horasTrabajadas === '' ||
      fecha2 === ''
    ) {
      Toast.show({
        text: 'Campos Vacios',
  ...
  addExternos = () => {
    ...
    if (
      descripcion === 0 ||
      this.state.trabajoDescripcion === '' ||
      costo === 0 ||
      this.state.costoTrabajo === '' ||
      AIU === 0 ||
      this.state.aiuTrabajo === ''
    ) {
      Toast.show({
        text: 'Campos Vacios',
        buttonText: 'Ok',
