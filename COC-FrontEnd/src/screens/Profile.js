            ...
            <ScrollView style={style.container}>
                <View style={style.headerBackgroundImage}>
                    ...
                    {this.props.usuario.user.foto === null ? (
                        <Image source={require('../assets/fotos/no-image.png')}
                               style={style.profileImage}/>
                    ) : (

                        <Image source={{uri: `http://192.168.1.55:3000/Pictures/${this.props.usuario.user.foto}`}}
                               style={style.profileImage}/>
                    )}
                ...
                <View style={style.infoProfile}>
                    ...
                    <View style={{flex: 1, alignItems: 'center', padding: '10%',}}>
                        <View style={style.card}>
                            <Image source={require('../assets/iconos/email.png')} style={style.IconItem}/>
                        ...
                        <View style={style.card}>
                            <Image source={require('../assets/iconos/accreditation.png')} style={style.IconItem}/>

                            <View style={{alignItems: 'flex-start', justifyContent: 'center'}}>
                                <Text style={{fontWeight: 'bold'}}>Identificación</Text>
                                <Text style={style.text}>{this.props.usuario.user.identificacion}</Text>
                            </View>

                        </View>

                        <View style={style.card}>
                            <Image source={require('../assets/iconos/monitoring.png')} style={style.IconItem}/>
                            <View style={{alignItems: 'flex-start', justifyContent: 'center'}}>
                        ...
                        <View style={{justifyContent: 'center', alignItems: 'center', left: '10%', margin: 10}}>
                            <Grid>
                                <Col>
                                    <TouchableOpacity style={style.buttonBack} onPress={() => this.CerrarSession()}>
                                        <Text style={[style.text, {color: 'white',}]}>
                                            Salir&nbsp;
                                            <Icon name={'sign-out-alt'} style={[style.IconItem, {color: 'white',}]}
                                                  color={'white'}
                                                  size={12}/>
                                        </Text>
                                    </TouchableOpacity>
                                ...
                                <Col>
                                    <TouchableOpacity style={style.buttonEdit}
                                        ...
                                        <Text style={[style.text, {color: 'white',}]}>
                                            Editar&nbsp;
                                            <Icon name={'edit'} style={[style.IconItem, {color: 'white',}]}
                                                  color={'white'}
                                                  size={12}/>
                                        </Text>
                                    </TouchableOpacity>
