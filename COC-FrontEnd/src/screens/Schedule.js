...
import {Body, Button, Container, Header, Card,  CardItem, Right, Text as TxT} from "native-base";
    ...
    _renderItem = ({item, index}) => {
        ...
        return (
            <View style={style.CronoCard}>
                ...
                <Text style={style.CronoText}>
                    <Icon name={'calendar-plus'} size={15}/> Fecha
                    Inicial: {item.fechaTemprano} - <Icon name={'clock'} size={15}/> {item.horaTemprano}</Text>
                <Text style={style.CronoText}>
                    <Icon name={'calendar-check'} size={15}/> Fecha
                    Final: {item.fechaFinTemprano} - <Icon name={'clock'} size={15}/> {item.horaFinTemprano}</Text>
