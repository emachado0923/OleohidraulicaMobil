...
import {
  ActualizarEstado,
  VerificandoConexion,
} from '../actions/Conection/connectionActions';

//dev
//const Url = 'http://192.168.1.55:3000/api';
//deployed
const Url = 'https://cocmovil.herokuapp.com/api/usuarios/login';
        ...
        <Formik
          ...
          validationSchema={yup.object().shape({
            identificacion: yup
              ...
              .min(10, 'La Identificación es de 10 caracteres!'),
            password: yup
              .string()
              .required('La contraseña es obligatoria! ')
              .min(7, 'La contraseña debe tener minimo de 7 caracteres!'),
          })}>
          {({
            values,
            handleChange,
            ...
            <ImageBackground
              source={require('@assets/fotos/tic-tac-toe.png')}
              style={LoginStyle.image}>
              <KeyboardAvoidingView style={LoginStyle.container}>
                <View style={LoginStyle.loginContainer}>
                  <View style={{justifyContent: 'center'}}>
                    <Image
                      source={require('@assets/fotos/logoEmpresa.png')}
                  ...
                  {conexionDisponible === true ? (
                    ...
                    <View>
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          this.props.navigation.navigate('MantenimientoNuevo')
                        }
